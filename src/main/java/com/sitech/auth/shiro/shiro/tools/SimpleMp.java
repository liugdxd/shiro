package com.sitech.auth.shiro.shiro.tools;
...
public class SimpleMp { 
  ...
  public void generateCode() { 
    //指定包名 
    String packageName = "com.sitech.auth.shiro.shiro"; 
  ...
  private GlobalConfig getGlobalConfig(boolean serviceNameStartWithI) { 
    ...
    globalConfig 
        ...
        .setAuthor("liugd") 
        //设置输出路径 
        .setOutputDir(getOutputDir("shiro")) 
  ...
  private DataSourceConfig getDataSourceConfig() { 
    String dbUrl = "jdbc:mysql://192.168.19.129:3307/shiro"; 
